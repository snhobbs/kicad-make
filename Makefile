...
#===============================================================
$(LOGS_DIR) $(MANUFACTURING_DIR) $(ASSEMBLY_DIR) $(GERBER_DIR) $(MECH_DIR) $(_OUTDIR):
	mkdir -p $@
...
.PHONY: release gerbers ipc2581 fabzip drc erc step ibom schematic boms board centroid testpoints manufacturing no-drc documents
